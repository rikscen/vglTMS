    ...
    public class DataSupport : IDisposable
    {
        ...
        public String ConnectionString
        {
            ...
            get
            {
                ...
                if (connectString == "")
                {
                    result = "Initial Catalog=" + Utils.DBConnection["TMS"]["DBNAME"] + ";Data Source=" + Utils.DBConnection["TMS"]["SERVER"] + ";User Id = " + Utils.DBConnection["TMS"]["USERNAME"] + "; Password = " + Utils.DBConnection["TMS"]["PASSWORD"];
                }
                else
