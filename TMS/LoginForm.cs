...
namespace TMS
{
    public partial class LoginForm : Form
    {
        ...
        public LoginForm()
        {
            ...
            this.Icon = Properties.Resources.tms_icon;
        }
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (!dbConnectionSettings.ContainsKey("TMS"))
            {
                MessageBox.Show(String.Format("TMS Database Connection not Initialize properly! \nReport this to the programmer!"), "LogIn Failed", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
            ...
            if (RegistrationSupport.IsCorrectUsernameAndPassword(txtUsername.Text, txtPassword.Text))
            {
                ...
                this.Visible = false;
                dialog.Text = "TRANSPORT MANAGEMENT SYSTEM - MAIN MENU";
