            ...
            for (var i = 0; i <= TabCount - 1; i++)
            {
                ...
                if (i == SelectedIndex)
                {
                    ...
                    using (var b = new SolidBrush(SelectedTabColor))
                    {
                        ...
                        TextRenderer.DrawText(Drawer, TabPages[i].Text, new Font(TabPages[i].Font.FontFamily, 15, FontStyle.Bold), HeaderSize, TabTextColor, TextFormatFlags.VerticalCenter | TextFormatFlags.HorizontalCenter);
                    }
                }
                else
                {
                    ...
                    using (var b = new SolidBrush(TabTextColor))
                    {
                        ...
                        b.Color = TabTextColor;
                        TextRenderer.DrawText(Drawer, TabPages[i].Text, new Font(TabPages[i].Font.FontFamily, 11, FontStyle.Bold), HeaderSize, TabTextColor, TextFormatFlags.VerticalCenter | TextFormatFlags.HorizontalCenter);
                    }
                }
            }
