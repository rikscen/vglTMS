...
namespace CustomComVGLHelper.CustomControls
{
    /// <summary>
    ...
    public class vglComboBox : ComboBox, IPopupControlHost
    {
        ...
        public vglComboBox(Control dropControl)
            : this()
        {
        ...
        #endregion IPopupControlHost Members
        ...
        #endregion Win32 message handlers
        ...
        #endregion Hide some unwanted properties
        ...
        /// Indicates if drop-down is currently shown.
        /// </summary>
        private bool m_bDroppedDown = false;
    ...
    internal class CustomComboBoxDesigner : ParentControlDesigner
    {
        ...
        #endregion ParentControlDesigner Overrides
    }
}